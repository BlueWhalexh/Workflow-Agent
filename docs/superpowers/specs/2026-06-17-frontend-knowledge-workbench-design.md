...
4. 运行：`POST /v1/workspaces/{workspaceId}/agent-runs`、`GET /v1/workspaces/{workspaceId}/agent-runs`（最近 20 条 public run envelope）、`GET /v1/agent-runs/{runId}`、`POST /v1/agent-runs/{runId}/cancel`。
